...
var require_git_hooks_list_shim = __commonJS({
  "git-hooks-list_shim.cjs"(exports2, module2) {
    var gitHooksList = require_git_hooks_list_shim();
    module2.exports = gitHooksList;
  }
});
...
// index.js
var import_git_hooks_list = __toESM(require_git_hooks_list_shim(), 1);
...
var hasOwn = (
  ...
  Object.hasOwn || // TODO: Remove this when we drop supported for Node.js v14
...
var overProperty = (property, over) => (object, ...args) => hasOwn(object, property) ? { ...object, [property]: over(object[property], ...args) } : object;
